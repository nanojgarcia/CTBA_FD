...
leaflet(options = leafletOptions(zoomSnap = 0.1)) %>%
  ...
  addLabelOnlyMarkers(
    ...
    label = to_title_case(community$community),
    labelOptions = labelOptions(noHide = T, textOnly = T, textsize = "10px",
                                style = list(
                                  "color" = "red"
                                )))
```
...
leaflet(options = leafletOptions(zoomSnap = 0.1)) %>%
  ...
  addPolygons(
    ...
    fillColor = ifelse(gent$one_gentri_2==1,"red",
                       ifelse(gent$one_gentri_1==1,"blue","gray")),
    fillOpacity = .6,
    weight = 1
  )
```
...
leaflet(options = leafletOptions(zoomSnap = 0.1)) %>%
  ...
  addPolygons(
    ...
    fillColor = ifelse(gent$one_gentri_4==1,"red",
                       ifelse(gent$one_gentri_3==1,"blue","gray")),
    fillOpacity = .6,
    weight = 1
  )
```
