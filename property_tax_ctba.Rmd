...
census <- census %>%
  mutate(gentri_1 = case_when(
    increase_value > 100 & value_18 > 200000 ~ 1,
    increase_value > 50 & value_18 > 220000 ~1,
    increase_value <= 100 & value_18 <= 200000 ~ 0,
    increase_value <= 50 & value_18 <= 220000 ~ 0,
    increase_value <= 50 ~ 0,
    value_18 <= 200000 ~ 0
    )
  )
...
census <- census %>%
  mutate(gentri_2 = case_when(
    increase_value > 100 & household_income_18 <= 61000 ~ 1,
    increase_value > 50 & household_income_18 <= 46000 ~1,
    increase_value <= 100 & household_income_18 > 61000 ~ 0,
    increase_value <= 100 & household_income_18 > 46000 ~ 0,
    increase_value <= 50 ~ 0,
