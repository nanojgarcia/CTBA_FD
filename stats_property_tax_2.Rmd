...
aggregate(cbind(change_latino = census_income$increase_latino,
  change_black = census_income$increase_black,
  change_p = census_income$increase_value,
  change_y = census_income$increase_income,
  change_rent = census_income$increase_rent
), # Specify data column
...
mean.test <- function(x) t.test(x ~ census_group$one_gentri_3)$p.value


table_gent_3 <- tabular(increase_value + increase_rent + increase_income +    increase_income_pc + increase_share_latino + increase_share_black ~ one_gentri_3 * (Median + Mean + std) + mean.test, data = census_group)

table_gent_3

toLatex(table_gent_3, digits =3)
...
mean.test <- function(x) t.test(x ~ census_group$one_gentri_4)$p.value


table_gent_4 <- tabular(increase_value + increase_rent + increase_income +    increase_income_pc + increase_share_latino + increase_share_black ~ one_gentri_4 * (Median + Mean + std) + mean.test, data = census_group)

table_gent_4

toLatex(table_gent_4, digits =3)
