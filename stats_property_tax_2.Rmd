...
table_gent_3 <- tabular(increase_value + increase_rent + increase_income +    increase_income_pc + increase_share_latino + increase_share_black_not_latino ~ one_gentri_3 * (Median + Mean + std) + mean.test, data = census_group)
...
table_gent_4 <- tabular(increase_value + increase_rent + increase_income +    increase_income_pc + increase_share_latino + increase_share_black_not_latino ~ one_gentri_4 * (Median + Mean + std) + mean.test, data = census_group)
